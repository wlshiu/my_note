...
awk -v fstr="$filterstr" '# function for filter the symbols you not concern
    ...
    BEGIN{ # filternode array are used to record the symbols who have been filtered.
        ...
        # printf("\tnode [shape=record,fontname=Arial,fontsize=11,fontcolor=black,style=filled,fillcolor=lightgrey];\n");
        printf("\tnode [shape=box,fontname=Arial,fontsize=11,fontcolor=black,style=filled,fillcolor=lightgrey];\n");
    }{
