...
rm_cmd_line='git rm --cached --ignore-unmatch '
rm_cmd_line=${rm_cmd_line}"$1"
...
## ${obj_path} can't pass data....
git filter-branch --force --index-filter "${rm_cmd_line}" --prune-empty --tag-name-filter cat -- --all
