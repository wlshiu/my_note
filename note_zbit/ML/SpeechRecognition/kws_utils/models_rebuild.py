...
def prepare_model_settings(label_count, sample_rate, clip_duration_ms,
    ...
    Args:
      ...
      sample_rate: Number of audio samples per second. 默認的兩個 + train時候指定的參數個數
    ...
    """
    desired_samples = int(sample_rate * clip_duration_ms / 1000)         #語音樣本點數16k=16000
    window_size_samples = int(sample_rate * window_size_ms / 1000)       #計算一幀的樣本個數以及幀移的樣本個數，這裡它們的值是640和640。
    window_stride_samples = int(sample_rate * window_stride_ms / 1000)
    length_minus_window = (desired_samples - window_size_samples)        #減去一幀DNN (16000-640)/640+1=25 cnn (16000-640)/320+1=49
